function affiliate_product_management()
{
	...
	display.innerHTML = "affiliate_product_management() <br/>";
	...
	xmlhttp.open("GET", "affiliate_page_functionality/affiliate_product_management_run.php", true);
	xmlhttp.send();
}
